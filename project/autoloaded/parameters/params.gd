...
# pickup_floaty
var player_pickup_floaty_x_movement_max = 0.37
var player_pickup_floaty_x_movement_delta = 0.7
var player_pickup_floaty_float = 0.2
var player_pickup_floaty_max_y_velocity = 2.0
